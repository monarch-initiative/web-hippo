...
import { Card, Image, Header, Container, Button, Icon } from 'semantic-ui-react';
  ...
  <Container text style={{ paddingTop: '5em', paddingBottom: '5em' }}>
    ...
    <Card fluid>
      ...
      <Card.Content>
        <Card.Description>
          <p>
            Start typing your phenotype, disease or gene you are looking for and pick it from
          ...
          <p>
            <Icon name="lightbulb" /> You can bookmark your search after hitting search button.
          </p>
        </Card.Description>
      </Card.Content>
    </Card>
      ...
      <Card.Content>
        <Card.Description>
          <p>
            ...
            centre, you can find the abstract with underlined entities, title, published date,
            authors and PMID. Hovering over the underlined text can give a quick preview of entities
            with a short description and feedback for that particular annotation.
          </p>
          <p>
            <Icon name="lightbulb" /> On the annotation popup, there is a link for detailed
      ...
      <Card.Content>
        <Card.Description>
          <p>
            ...
            articles having TNF co-occurred with Hypertention and Myocardial Infarction (at least
            one of them). Filters can be removed by clicking them again or you can just eliminate
            one by one from applied filters list.
          </p>
          <p>
            <Icon name="lightbulb" /> To keep your result set concise, start with one search item
            and apply filter to find associations.
          </p>
        </Card.Description>
      </Card.Content>
    </Card>
      ...
      <Card.Content>
        <Card.Description>
          <p>
            ...
            eye on published research having your desired entity, you can subscribe your search
            query. All you have to do is click on search subscription and fill in a form with your
            search name, a valid email id and frequency of digest.
          </p>
          <p>
            <Icon name="lightbulb" /> The subscription will take care of search query only (not
            filters), so that you don’t miss anything.
          </p>
        </Card.Description>
      </Card.Content>
    </Card>
    ...
    <Button
      onClick={() => {
        window.scrollTo(0, 0);
        history.push('/query/HP:0001658,HP:0000822');
      }}
    >
      Try Now
    </Button>
